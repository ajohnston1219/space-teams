...
INSERT INTO auth.applications
    (id, name, api_key)
VALUES
    ('cc5568d0-c827-4cb0-aaf4-ff371952a817', 'auth',         'SPACECRAFT-AUTH'),
    ('c2fb3047-061e-4a73-95a0-4258b515929f', 'sims',         'SPACECRAFT-SIMS'),
    ('6cf4277d-04b8-497a-a66b-4b3b1eace350', 'competitions', 'SPACECRAFT-COMPETITIONS'),
    ('fb497e07-2b5f-434b-ba60-d2320a061003', 'messages',     'SPACECRAFT-MESSAGES'),
    ('cc5568d0-c827-4cb0-aaf4-ff371952a817', 'application', 'SPACECRAFT-API-KEY');
...
INSERT INTO billing.discount_codes
    (id, code,     affiliate_id)
VALUES
    (0,  'TEST5',  '62736b74-2b9e-4921-8180-52e09f39ad74'),
    (1,  'TEST10', 'de808080-8037-4f36-ad99-4f48f9514402');

INSERT INTO billing.discount_code_ranges
    (discount_code_id, competition_id, up_to, discount_amount)
VALUES
    (0, 'e9e9ccb0-fe26-4e90-a174-005f14d37976',  5, 0.10),
    (0, 'e9e9ccb0-fe26-4e90-a174-005f14d37976', -1, 0.05),
    (1, 'e9e9ccb0-fe26-4e90-a174-005f14d37976', -1, 0.10),
